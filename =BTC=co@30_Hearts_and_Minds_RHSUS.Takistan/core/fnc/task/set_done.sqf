...
switch _task_id do {
    case 0 : {
        _description = [localize "str_a3_cfgmusic_eventtrack01_f_curator", localize "STR_BTC_HAM_MISSION_DEFEAT_WIN_TEXT"]; //"Mission accomplished!","ISIS have been finally defeated!    Mission accomplished!"
    };
    case 1 : {
