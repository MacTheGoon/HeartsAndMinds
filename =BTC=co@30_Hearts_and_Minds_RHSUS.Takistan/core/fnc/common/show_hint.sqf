...
switch (_type) do {
    ...
    case 6 : {
        hint localize "STR_BTC_HAM_O_COMMON_SHOWHINTS_6"; //In the last hideout we found important intel about all the cities occupied by ISIS! Size the last positions held by the enemies and defeat them once and for all
    };
    case 7 : {
